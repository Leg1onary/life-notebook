...
## 6. Список эмоций (из задания психолога)
...
## 16. Список будущих улучшений после основной сборки проекта

- Inbox — быстрые заметки без раздела прямо с главного экрана
- Улучшить To-do — срок выполнения, сортировка перетаскиванием
- Улучшить Психолог — статистика эмоций за неделю, график
